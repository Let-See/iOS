...
public struct Breed: Codable, CustomStringConvertible, Identifiable {
	public let id: String
	public let name: String
	public let temperament: String
	public let breedExplaination: String
	public let energyLevel: Int
	public let isHairless: Bool
...
extension Breed: LetSeeMockProviding {
	public static var mocks: Set<LetSeeMock> {
		return [
			.error(name: "BadResponse", URLError(.badServerResponse)),
			.defaultSuccess(name: "Just One Cat", data: """
					[
					   {
						 "weight": {
						   "imperial": "7  -  10",
			...
			"""),
			.defaultSuccess(name: "Two Dogs", data: """
					[
				{
			 "weight": {
			   "imperial": "7  -  10",
			 ...
			 "country_codes": "EG",
			 "country_code": "EG",
			 "description": "A guitarist is a person who plays the guitar. Guitarists may play a variety of guitar family instruments such as classical guitars, acoustic guitars, electric guitars, and bass guitars. Some guitarists accompany themselves on the guitar by singing or playing the harmonica, or both. ",
			 "life_span": "14 - 15",
			 "indoor": 0,
			 "lap": 1,
			 "alt_names": "",
			 ...
			 "image": {
			   ...
			   "width": 1204,
			   "height": 1445,
			   "url": "https://en.bcdn.biz/Images/2018/5/9/38adae01-37d4-460c-83f5-5327b9bafe0b.jpg"
				}
			},
					   {
						 "weight": {
						 ...
						 "image": {
						   ...
						   "width": 1204,
						   "height": 1445,
						   "url": "https://ae01.alicdn.com/kf/HLB1VmOnbEzrK1RjSspmq6AOdFXad/Funny-Guitar-Player-Cosplay-Dog-Costume-For-Small-Dog-Large-Dog-Pet-Cat-Funny-Golden-Retriever.jpg"
						 }
					   }
			]
			""")
